 ...
 * It tests the creation and retrieval of a Vessel object using
 * TestRestTemplate.
 */
@SpringBootTest(classes = com.example.springboot.Application.class, // The main application class to initialize the
                                                                    // Spring context.
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT // Use a random port for each test to avoid
                                                                   // conflicts.
)
@Testcontainers
public class VesselTest {
    ...
    public static void setUp() throws Exception {
        ...
        try (
            ...
            String createTableSQL = "CREATE TABLE IF NOT EXISTS vessel (" +
                    "id UUID PRIMARY KEY, " +
                    "type VARCHAR(255), " +
                    "color VARCHAR(255));";

            // SQL statements to insert default data into the "vessel" table
            String insertDataSQL = "INSERT INTO vessel (id, type, color) VALUES " +
    ...
    void testCreateVessel() {
        // Create a new Vessel object with a randomly generated UUID, type 'Cargo', and
        // color 'Red'
